...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Brought a crappy old car with a smoky engine to Shaz, and he managed to get it fixed within 2 days (delivery for parts got delayed due to bank holiday) Very reliable service which is not even costly! Support the local so that we will have people like Shaz to help us when things get so desperate 🙏🏻",
    name: "Jackson Wong",
  },
